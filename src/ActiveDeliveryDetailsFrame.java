...
public class ActiveDeliveryDetailsFrame extends JFrame {
    ...
    public ActiveDeliveryDetailsFrame(int orderId, DeliveryDashboardFrame deliveryDashboardFrame) {
        ...
        // Accept Button
        JButton completeDeliveryBtn = new JButton("Complete Delivery");
        completeDeliveryBtn.addActionListener(e -> completeDelivery(orderId));
        completeDeliveryBtn.setPreferredSize(new Dimension(150, 25));
        buttonsPanel.add(completeDeliveryBtn);
    ...
    private void completeDelivery(int orderId) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            JOptionPane.showMessageDialog(this, "Error confirming delivery the order.");
            ex.printStackTrace();
        }
    }
